...
//for change in x axis or y axis, #newXScale, chosenXAxis,
...
//function used for updating state labels with a transition to new #newXScale, chosenXAxis,
...
d3.csv("FreightStates.csv").then(function(censusData) {
